...
export default function Login() {
    ...
    const [recoveryStep, setRecoveryStep] = useState<'email' | 'otp' | 'new-password'>('email');
    ...
    const handleRecoveryEmailSubmit = () => {
        console.log('Recovery email submitted:', recoveryEmail);
        setRecoveryStep('otp');
    };

    const handleRecoveryOtpSubmit = () => {
        console.log('Recovery OTP submitted:', recoveryOtp);
        setRecoveryStep('new-password');
    };

    const handleRecoveryPasswordSubmit = () => {
        console.log('Password reset submitted:', { recoveryEmail, recoveryOtp, newPassword, confirmPassword });
        handleRecoveryBack();
    };
                            ...
                            <div className="space-y-6" id="recovery-panel">
                                <div className="text-center space-y-2">
                                    ...
                                    <p className="text-sm text-[#444650]">
                                        {recoveryStep === 'email' && 'Enter your admin email to receive a verification code.'}
                                        {recoveryStep === 'otp' && 'Enter the OTP sent to your email.'}
                                        {recoveryStep === 'new-password' && 'Create a new password to complete recovery.'}
                                    </p>
                                </div>
                                ...
                                {recoveryStep === 'otp' && (
                                    <div className="space-y-6">
                                        <div className="relative input-container">
                                            <input
                                                className="w-full bg-transparent border-t-0 border-l-0 border-r-0 border-b-2 border-[#c5c6d2] py-3 px-0 focus:ring-0 text-[#00113a] font-body transition-all tracking-[0.3em]"
                                                id="recovery-otp"
                                                placeholder=" "
                                                type="text"
                                                inputMode="numeric"
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button
                                                className="px-4 py-2 text-sm bg-[#002366] text-white rounded hover:bg-[#00113a]"
                                                type="button"
                                                onClick={handleRecoveryOtpSubmit}
                                            >
                                                Verify OTP
                                            </button>
                                        </div>
